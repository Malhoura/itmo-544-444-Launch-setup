...
#health check
aws elb configure-health-check --load-balancer-name $3 --health-check Target=HTTP:80/form.php,Interval=30,UnhealthyThreshold=2,HealthyThreshold=2,Timeout=3 
